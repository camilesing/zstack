 ...
 */
public class TestCreateVmOnKvmAndOneL3IpRangeNetWork {
    ...
    public void setUp() throws Exception {
        ...
        deployer = new Deployer("deployerXml/kvm/TestCreateVmOnKvmAndOneL3IpRangeNetWork.xml", con);
	...
	public void test() throws ApiSenderException {
        ...
        L3NetworkInventory l3_1 = deployer.l3Networks.get("TestL3Network1");
        L3NetworkInventory l3_2 = deployer.l3Networks.get("TestL3Network2");
        L3NetworkInventory l3_3 = deployer.l3Networks.get("TestL3Network3");
        ...
        creator.addL3Network(l3_1.getUuid());
        creator.name = "vm";
        ...
        creator.addL3Network(l3_2.getUuid());
        creator.create();
        creator.addL3Network(l3_3.getUuid());
        creator.create();
    }
